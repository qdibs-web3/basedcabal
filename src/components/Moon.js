...
import milestone1Icon from '../assets/coins.png';
import milestone2Icon from '../assets/coins.png';
import milestone3Icon from '../assets/coins.png';
import milestone4Icon from '../assets/coins.png';
import milestone5Icon from '../assets/coins.png';
import milestone6Icon from '../assets/coins.png';
...
function Gems() {
    ...
    const milestones = [
        { label: "Milestone 1", value: 100000, icon: milestone1Icon },
        { label: "Milestone 2", value: 400000, icon: milestone2Icon },
        { label: "Milestone 3", value: 750000, icon: milestone3Icon },
        { label: "Milestone 4", value: 1100000, icon: milestone4Icon },
        { label: "Milestone 5", value: 1500000, icon: milestone5Icon },
        { label: "Milestone 6", value: 1900000, icon: milestone6Icon },
    ];
